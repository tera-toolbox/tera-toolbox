...
function GetString(str, tokens) {
    switch (str) {
        ...
        case 'connectionmanager/error-ECONNABORTED-ECONNRESET-EPIPE-1': return `[connection] ERROR: ${tokens.code} - Connection to game server was closed unexpectedly. Common reasons for this are:`;
        case 'connectionmanager/error-ECONNABORTED-ECONNRESET-EPIPE-2': return '[connection] - A disconnect caused by an unstable internet connection';
        case 'connectionmanager/error-ECONNABORTED-ECONNRESET-EPIPE-3': return '[connection] - An exploit/cheat or broken module that got you kicked';
