...
function GetString(str, tokens) {
    switch (str) {
        ...
        case 'gui/main/static/tabs/credits/content': return 'Thanks to<br />SaltyMonkey: Installer<br />Mathicha &amp; Pentagon: Core GUI stuff<br />Meishu: Original Tera-Proxy Core<br />All Mod Developers';
