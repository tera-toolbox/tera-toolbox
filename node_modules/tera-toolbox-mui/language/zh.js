...
function GetString(str, tokens) {
    switch (str) {
        // connection-manager
        case 'connection-manager/error-ETIMEDOUT-1': return `[连接错误]: 无法连接到服务器${tokens.address}:${tokens.port} (连接超时)! 通常导致这个问题的原因:`;
        case 'connection-manager/error-ETIMEDOUT-2': return '[连接错误]: 网络连接不稳定，或者IP被地区封锁.';
        case 'connection-manager/error-ETIMEDOUT-3': return '[连接错误]: 游戏服务器正在维护.';
