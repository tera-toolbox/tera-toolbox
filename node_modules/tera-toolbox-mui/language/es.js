...
function GetString(str, tokens) {
    switch (str) {
        ...
        case 'mod/mod-network-instance-loaded': return `[mods] El modulo ${tokens.name} ha establecido contacto con el servidor`;
        case 'mod/mod-network-instance-load-error-1': return `[mods] ERROR: El modulo ${tokens.name} no pudo establecer contacto el servidor!`;
        case 'mod/mod-network-instance-load-error-2': return `[mods] ERROR: Contactate con el autor del modulo:: ${tokens.supportUrl}`;
        case 'mod/mod-network-instance-unloaded': return `[mods] El modulo ${tokens.name} fue desconectado del servidor`;
        case 'mod/mod-network-instance-unload-error-1': return `[mods] ERROR: El modulo ${tokens.name} no pudo ser desconectado del servidor!`;
