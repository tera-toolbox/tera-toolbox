...
function GetString(str, tokens) {
    switch (str) {
        ...
        case 'gui/main/static/tabs/settings/content/noserverautojoin': return 'Desactivar conexion automatica al servidor';        case 'gui/main/static/tabs/settings/content/minimizetotray': return 'Minimizar a la bandeja del sistema';
