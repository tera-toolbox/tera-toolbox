...
function GetString(str, tokens) {
    switch (str) {
        ...
        case 'gui/main/static/tabs/credits/content': return 'Hvala<br />SaltyMonkey: Installer<br />Mathicha &amp; Pentagon: Core GUI stuff<br />Foglio: Logo design<br />Meishu: Original Tera-Proxy Core<br />All Toolbox Translators<br />All Mod Developers';
