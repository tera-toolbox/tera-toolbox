...
function GetString(str, tokens) {
    switch (str) {
        ...
        case 'connectionmanager/error-ECONNABORTED-ECONNRESET-EPIPE-1': return `[connection] :تم إغلاق الإتصال بخادم اللعبة بشكل غير متوقع. الأسباب الشائعة لهذا هي - ${tokens.code} :خطأ`;
        case 'connectionmanager/error-ECONNABORTED-ECONNRESET-EPIPE-2': return '[connection] - انقطاع الاتصال ناتج عن شبكة إنترنت غير مستقرة';
        case 'connectionmanager/error-ECONNABORTED-ECONNRESET-EPIPE-3': return '[connection] - استغلال ثغرة أو غش أو تطبيق معطل تسبب فى طردك';
