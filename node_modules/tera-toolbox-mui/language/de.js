...
function GetString(str, tokens) {
    switch (str) {
        ...
        case 'connectionmanager/error-ECONNABORTED-ECONNRESET-EPIPE-1': return `[Verbindung] FEHLER: ${tokens.code} - Die Verbindung zum Spiele-Server wurde unerwartet geschlossen. Häufige Gründe hierfür sind:`;
        case 'connectionmanager/error-ECONNABORTED-ECONNRESET-EPIPE-2': return '[Verbindung] - Eine Unterbrechung aufgrund einer instabilen Internetverbindung';
        case 'connectionmanager/error-ECONNABORTED-ECONNRESET-EPIPE-3': return '[Verbindung] - Ein Exploit / Cheat oder beschädigtes Modul, welches zum Kick geführt hat.';
