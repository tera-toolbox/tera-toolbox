...
function GetString(str, tokens) {
    switch (str) {
        ...
        case 'gui/main/static/tabs/credits/content': return 'Danke an<br />SaltyMonkey: Installationsprogramm<br />Mathicha &amp; Pentagon: Benutzeroberfläche<br />Foglio: Logo-Design<br />Meishu: Ursprünglicher Tera-Proxy<br />Allen Toolbox-Übersetzern<br />Allen Modul-Entwickler';
