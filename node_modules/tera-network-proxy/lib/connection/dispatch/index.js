...
class Dispatch {
    ...
    fromRaw(name, version, data) {
        return this.protocol.parse(this.protocolVersion, name, version, data, null);
    }

    toRaw(name, version, data) {
        return this.protocol.write(this.protocolVersion, name, version, data, null, null, null);
    }

    resolve(name) {
        return this.protocol.resolveIdentifier(this.protocolVersion, name);
    }
