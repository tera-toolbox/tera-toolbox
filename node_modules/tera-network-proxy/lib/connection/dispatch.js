...
class Dispatch {
    constructor(connection) {
        ...
        Object.keys(this.connection.metadata.maps.protocol).forEach(name => this.addOpcode(name, this.connection.metadata.maps.protocol[name], this.connection.session.hasPadding(this.connection.metadata.maps.protocol[name])));
        ...
        // Initialize protocol
        this.protocol = new protocol(this.majorPatchVersion, this.minorPatchVersion, this.protocolMap, this.platform);
