    ...
    if (standalone) {
        ...
        if (moduleInfo && moduleManifest) {
            ...
            Object.assign(result, {
                ...
                'packets': moduleManifest.defs || result.packets,
            });
        }
    }
    ...
    load(name) {
        ...
        if (!moduleInfo) {
            ...
            try {
                ...
                console.error(`[mods] Loaded module "${moduleInfo.name}"`);
            } catch (e) {
        ...
        if (!moduleInfo) {
            ...
            if (!module) {
                ...
                try {
                    ...
                    console.error(`[mods] Unloaded module "${moduleInfo.name}"`);
                } catch (e) {
...
module.exports = { listModules, ModuleManager };
