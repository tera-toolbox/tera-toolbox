        ...
        do {
            ...
            this.installedModules.forEach((moduleInfo, moduleName) => {
                moduleInfo.dependencies.forEach(dependency => {
                    if (!this.installedModules.has(dependency)) {
                        console.error(`[mods] ERROR: Module "${moduleInfo.name}" requires "${dependency}" to be installed, but it is not!`);
            ...
            this.installedModules.forEach((moduleInfo, moduleName) => {
                moduleInfo.conflicts.forEach(conflict => {
                    if (this.installedModules.has(conflict)) {
                        console.error(`[mods] ERROR: Module "${moduleInfo.name}" is cannot be loaded while "${conflict}" is installed!`);
                        this.installedModules.delete(moduleName);
                        ModulesRemoved = true;
                    }
                });
