...
class Dispatch extends EventEmitter {
	...
	setProtocolVersion(version) {
        ...
        if (this.connection.info.protocol_data[this.protocolVersion]) {
            this.region = this.connection.info.region
            ...
            if(this.protocolVersion !== 0) {
                ...
                log.error('[dispatch] Unless a major game update was released within the past few hours, this')
                log.error('[dispatch] means that you are trying to play using an outdated client version!')
