...
class ProcessListener {
    ...
    update() {
        snapshot("pid", "name", "path", "ppid").then(processes => {
            ...
            console.log('[toolbox] ERROR: Unable to scan for game clients! Full error message:');
            console.log(`[toolbox] ERROR: ${error}`);
        });
    }
}
