...
class TeraClientInterfaceServer {
    constructor(host, port, moduleFolder, onAccept, onReady, onError) {
        ...
        this.processListener = new ProcessListener('TERA.exe', this.handleAddedProcess, this.handleRemovedProcess, 100);
    }
    ...
    accept(socket) {
        ...
        this.processListener.interval = 1000;
    }

    onDisconnect(connection) {
        this.connections.delete(connection);
        if (this.processListener)
            this.processListener.interval = this.connections.size > 0 ? 1000 : 100;
    }
