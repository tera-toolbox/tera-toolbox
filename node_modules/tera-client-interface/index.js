...
class TeraClientInterfaceServer {
    constructor(isAdmin, host, port, onAccept, onReady, onError) {
        ...
        if (process.platform === 'win32') {
            ...
            this.processListener = new scanner('TERA.exe', path.join(__dirname, 'tera-client-interface.dll'), '', 25);
        } else {
    ...
    accept(socket) {
        ...
        const connection = new TeraClientInterfaceConnection(socket, this.GPKManager);
