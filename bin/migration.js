...
function ToolboxMigration() {
    ...
    rimraf(path.join(__dirname, "gui", "icons"));
    ...
    tryUnlink(path.join(__dirname, "gui", "icon.ico"));
    tryUnlink(path.join(__dirname, "gui", "icon_xmas.ico"));
    tryUnlink(path.join(__dirname, "gui", "main.js"));
    tryUnlink(path.join(__dirname, "gui", "splash.js"));
    tryUnlink(path.join(__dirname, "gui", "splash.mp4"));
    tryUnlink(path.join(__dirname, "gui", "splash_xmas.mp4"));
    tryUnlink(path.join(__dirname, "gui", "js", "jquery-3.2.1.min.js"));
    tryUnlink(path.join(__dirname, "gui", "js", "jquery-3.4.1.min.js"));
    tryUnlink(path.join(__dirname, "..", "node_modules", "tera-mod-ui", "settings_ui", "icon.png"));
    tryUnlink(path.join(__dirname, "..", "node_modules", "tera-mod-ui", "settings_ui", "jquery-3.2.1.min.js"));
